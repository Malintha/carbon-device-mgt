...
CREATE TABLE IF NOT EXISTS DM_IOT_DEVICE_TYPE (
...
CREATE TABLE IF NOT EXISTS DM_IOT_OPERATION (
    ID INT AUTO_INCREMENT NOT NULL,
    NAME VARCHAR(300) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS DM_DEVICE_OPERATION_MAP (
  ID INT AUTO_INCREMENT NOT NULL,
  DEVICE_ID INTEGER NOT NULL,
  OPERATION_ID  VARCHAR(300),
  STATUS VARCHAR(300),
  PRIMARY KEY (ID),
  CONSTRAINT fk1_dm_device_operation_map FOREIGN KEY (OPERATION_ID) REFERENCES
    DM_IOT_OPERATION (ID) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT fk2_dm_device_operation_map FOREIGN KEY (DEVICE_ID) REFERENCES
    DM_DEVICE (ID) ON DELETE NO ACTION ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS DM_IOT_DEVICE (
...
CREATE TABLE IF NOT EXISTS DM_IOT_DEVICE_PROPERTY (
  ID INTEGER AUTO_INCREMENT NOT NULL,
  DEVICE_ID INT NULL,
